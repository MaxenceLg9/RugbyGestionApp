<?php include_once $_SERVER["DOCUMENT_ROOT"]."../libs/components/nav.php" ?>
<div class="main">
    ...
    <article>
        ...
        <section class="header-section section-index">
            <h1>
                Bienvenue <strong class="strong-bienvenue">
<!--                    TODO je peux laisser en PHP dur car pas dynamique?php echo $_SESSION['prenom']." ".$_SESSION["nom"] ?>-->
                </strong> !
            </h1>
            <p>
...
<!--         TODO gérer les csrf tokens   <div class="actions">-->
