...
//                    for($i = 1; $i <= 23; $i++){
//                        $value = ""?>
<!--                        <div class="position-slot slot---><?php //=$i?><!--" data-position="--><?php //=$i?><!--">-->
<!--                            --><?php
...
<!--                --><?php //if($archive){ ?>
<!--                    <p>Le match est archivé, vous ne pouvez plus le modifier</p>-->
<!--                    <p>Résultat : --><?php //=$match->getResultat()->name?><!--</p>-->
<!--                    <a class="button saisie" href="/gererfdm.php?type=notes&idMatch=--><?php //=$match->getIdMatch()?><!--&csrf_token=--><?php //=htmlspecialchars(hash_hmac("sha256", $match->getIdMatch() . $_SESSION["csrf_token"] ."notes",$csrf_token))?><!--">-->
<!--                        <p>Saisir les notes</p>-->
<!--                    </a>-->
<!--                --><?php //} else { ?>
<!--                    <input type="hidden" name="type" value="ajout">-->
<!--                    <input type="hidden" name="csrf_token" value="--><?php //= htmlspecialchars(hash_hmac("sha256", $match->getIdMatch() . $_SESSION['csrf_token'] . "ajout", $csrf_token)) ?><!--">-->
<!--                    <input type="hidden" name="idMatch" value="--><?php //=$_GET["idMatch"]?><!--">-->
<!--                    --><?php //if($valider){ ?>
<!--                        <div class="row">-->
...
<!--                                    <option value="--><?php //= $resultat->name ?><!--">-->
<!--                                        --><?php //= htmlspecialchars($resultat->name) ?>
<!--                                    </option>-->
<!--                                --><?php //} ?>
<!--                            </select>-->
<!--                        </div>-->
...
<!--                    --><?php //} else { ?>
<!--                        <input type="hidden" name="idMatch" value="--><?php ////=$match->getIdMatch()?><!--">-->
...
<script src="../../public/resources/js/fdm.js"></script>